...
./git-subsplit.sh publish --no-tags src/Litepie/Http:git@github.com:Litepie/http.git
./git-subsplit.sh publish --no-tags src/Litepie/Install:git@github.com:Litepie/install.git
./git-subsplit.sh publish --no-tags src/Litepie/Master:git@github.com:Litepie/master.git
