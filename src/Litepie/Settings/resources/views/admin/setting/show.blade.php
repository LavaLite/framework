    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs primary">
            ...
            <div class="box-tools pull-right">
                                <button type="button" class="btn btn-success btn-sm" data-action='NEW' data-load-to='#settings-setting-entry' data-href='{{trans_url('admin/settings/setting/create')}}'><i class="fa fa-plus-circle"></i> {{ trans('app.new') }}</button>
                @if($setting->id )
