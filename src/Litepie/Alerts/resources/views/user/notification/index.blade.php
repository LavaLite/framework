                ...
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="header-form">
                                   ...
                                   ->method('GET')
                                   ->class('form pn')
                                   ->alerts(trans_url(get_guard('url').'/alerts/notification'))!!}
                                    ...
                                    {!! Form::close()!!}
                                    <a href="{!!trans_url(get_guard('url').'/alerts/notification/create')!!}" rel="tooltip" class="btn btn-white btn-round btn-simple btn-icon pull-right add-new" data-original-title="" title="">
                    ...
                    <td>{{ $notification->read_at }}</td>
                                    <td class="td-alerts">
                                        ...
                                        <a href="{!! trans_url(get_guard('url').'/alerts/notification') !!}/{!! $notification->getRouteKey() !!}/edit" rel="tooltip" data-toggle="tooltip" data-placement="top" title="Edit Notification" class="btn btn-success btn-simple">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <a rel="tooltip" data-toggle="tooltip" data-placement="top" title="Remove Notification" class="btn btn-danger btn-simple" data-alerts="DELETE" data-href="{!! trans_url(get_guard('url').'/alerts/notification') !!}/{!! $notification->getRouteKey() !!}" data-remove="{!! $notification->getRouteKey() !!}">
