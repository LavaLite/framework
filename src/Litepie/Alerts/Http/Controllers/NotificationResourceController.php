...
namespace Litepie\Alerts\Http\Controllers;

use App\Http\Controllers\ResourceController as BaseController;
use Litepie\Alerts\Http\Requests\NotificationRequest;
...
class NotificationResourceController extends BaseController
{
    ...
    public function __construct(NotificationRepositoryInterface $notification)
    {
        ...
        $this->repository
            ...
            ->pushCriteria(\Litepie\Alerts\Repositories\Criteria\NotificationResourceCriteria::class);
    }
    ...
    public function index(NotificationRequest $request)
    {
        ...
        if ($this->response->typeIs('json')) {
            ...
            $data      = $this->repository
                ->setPresenter(\Litepie\Alerts\Repositories\Presenter\NotificationListPresenter::class)
        ...
        return $this->response->title(trans('alerts::notification.names'))
    ...
    public function show(NotificationRequest $request, Notification $notification)
    {
        ...
        return $this->response->title(trans('app.view') . ' ' . trans('alerts::notification.name'))
    ...
    public function create(NotificationRequest $request)
    {
        ...
        $this->response->title(trans('app.new') . ' ' . trans('alerts::notification.name')) 
    ...
    {
        return $this->response->title(trans('app.edit') . ' ' . trans('alerts::notification.name'))
