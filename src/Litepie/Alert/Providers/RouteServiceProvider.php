...
use Litepie\Alert\Models\Alert;
use Request;
use Route;
...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Litepie\Alert\Http\Controllers';
    ...
    public function boot()
    {
        ...
        if (Request::is('*/alert/notification/*')) {
            Route::bind('notification', function ($notification) {
                $notificationrepo = $this->app->make(\Litepie\Alert\Interfaces\NotificationRepositoryInterface::class);
