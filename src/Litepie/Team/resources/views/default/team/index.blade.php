    ...
    <div class="app-list-inner">
        <div class="app-list-header d-flex align-items-center justify-content-between">
            ...
            <button type="button" class="btn add-app-btn btn-icon btn-outline" data-action='CREATE'
                data-load-to="#app-entry" data-url="{{guard_url('user/team/create')}}">
        ...
        <div class="app-list-wrap-inner ps ps--active-y" id="app-list">
            <div class="app-list-toolbar">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="{{guard_url('user/client')}}"><i class="las la-user-tie"></i>Client</a>
                        <a class="dropdown-item" href="{{guard_url('teams/team')}}"><i class="las la-users"></i>Team</a>
            ...
            <div class="app-items" data-url="{{guard_url('teams/team')}}" id="item-list">
                @include('team::team.more', ['mode' => 'list'])
            </div>
...
<script type="">
    var module_link = "{{guard_url('teams/team')}}";
