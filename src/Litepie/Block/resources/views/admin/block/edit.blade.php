    ...
    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs primary">
            ...
            <div class="box-tools pull-right">
                ...
                <button type="button" class="btn btn-default btn-sm" data-action='CANCEL' data-load-to='#block-block-entry' data-href='{{trans_url('admin/block/block')}}/{{$block->getRouteKey()}}'><i class="fa fa-times-circle"></i> {{ trans('app.cancel') }}</button>
            </div>
        </ul>
        {!!Form::vertical_open()
        ->id('block-block-edit')
