<div class="box-header with-border">
    ...
    <div class="box-tools pull-right">
        <button type="button" class="btn btn-primary btn-sm" data-action='CREATE' data-form='#edit-menu' data-load-to='#menu-entry' data-href='{!!Trans::to('admin/menu/submenu/0')!!}'><i class="fa fa-floppy-o"></i> {{ trans('cms.save') }}</button>
