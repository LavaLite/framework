<div class="panel panel-default alt with-footer">
            ...
            <li class="media b-bl">
                <a href="#">
                    ...
                    <div class="media-body">
                        ...
                        <span class="time">{{@$value->created_at}}<span class="pull-right">{{@$value->ip}}</span></span>
                    </div>
                </a>
            </li>
            @empty
    ...
    <div class="footer">
        <a href="{{url(getenv('auth.guard').'/revision/activity')}}" class="btn btn-danger btn-sm btn-raised">See more</a>
    </div>
</div>