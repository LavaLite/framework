        ...
        <td valign="top" class="content" bgcolor="#CEF">
     		<table width="100%" border="0" cellspacing="0" cellpadding="" style="margin-bottom: 30px;">
              <td width="80%" style="padding-top: 20px;">
               ...
               <span style="color: #270188; font-size: 12px; font-weight:bold;">Name:         {!!@$data['name']!!}</span><br />
               <span style="color: #270188; font-size: 12px; font-weight:bold;">Email Id:     {!!@$data['email']!!}</span><br />
               <span style="color: #270188; font-size: 12px; font-weight:bold;">Phone:      {!!@$data['phone']!!}</span><br />
              <span style="color: #270188; font-size: 12px; font-weight:bold;">Message:       {!!@$data['message']!!}</span><br />
              </td>
          </table>
