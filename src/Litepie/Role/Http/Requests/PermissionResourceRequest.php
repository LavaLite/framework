...
namespace Litepie\Role\Http\Requests;

use Litepie\Http\Request\AbstractRequest;

class PermissionResourceRequest extends AbstractRequest
{
    /**
    ...
    public function authorize()
    {
        ...
        if (is_null($this->model)) {
            ...
            return $this->user()->can('view', app(config('role.permission.model.model')));
        }
