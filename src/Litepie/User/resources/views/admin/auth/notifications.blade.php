...
$(document).ready(function(){
    ...
    app.load('#notification-notification-entry', '{!!trans_url('/admin/user/notification/0')!!}');
    ...
    $('#notification-notification-list tbody').on( 'click', 'tr', function () {
        ...
        $('#notification-notification-entry').load('{!!trans_url('/admin/user/notification')!!}' + '/' + d.id);
