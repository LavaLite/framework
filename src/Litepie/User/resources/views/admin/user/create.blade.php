<div class="box-header with-border">
    <h3 class="box-title"> {{ trans('cms.new') }}  {{ trans('user::user.user.name') }} </h3>
    <div class="box-tools pull-right">
        ...
        <button type="button" class="btn btn-default btn-sm" data-action='CANCEL' data-load-to='#entry-user' data-href='{{trans_url('admin/user/user/0')}}'><i class="fa fa-times-circle"></i> {{ trans('cms.cancel') }}</button>
