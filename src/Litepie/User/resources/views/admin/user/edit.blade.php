<div class="box-header with-border">
    ...
    <div class="box-tools pull-right">
        ...
        <button type="button" class="btn btn-default btn-sm" data-action='CANCEL' data-load-to='#entry-user' data-href='{{trans_url('admin/user/user/'.$user->getRouteKey())}}'><i class="fa fa-times-circle"></i> {{ trans('cms.cancel') }}</button>
