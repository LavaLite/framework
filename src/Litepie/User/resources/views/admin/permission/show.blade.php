<div class="box-header with-border">
    <h3 class="box-title"> {{ trans('cms.view') }}   {{ trans('user::user.permission.name') }}  [{{ $permission->name }}]  </h3>
    <div class="box-tools pull-right">
       <button type="button" class="btn btn-success btn-sm" data-action='NEW' data-load-to='#entry-permission' data-href='{{trans_url('admin/user/permission/create')}}'><i class="fa fa-times-circle"></i> {{ trans('cms.new') }}</button>
        @if($permission->id)
