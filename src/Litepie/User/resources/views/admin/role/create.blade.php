<div class="box-header with-border">
    <h3 class="box-title"> {{ trans('cms.new') }}  {!! trans('user::user.role.name') !!} </h3>
    <div class="box-tools pull-right">
        ...
        <button type="button" class="btn btn-default btn-sm" data-action='CLOSE' data-load-to='#user-role-entry' data-href='{{trans_url('admin/user/role/0')}}'><i class="fa fa-times-circle"></i> {{ trans('cms.close') }}</button>
