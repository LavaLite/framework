    ...
    <div class="app-list-inner">
        <div class="app-list-header d-flex align-items-center justify-content-between">
            ...
            <button type="button" class="btn add-app-btn btn-icon btn-outline" data-action='CREATE'
                data-load-to="#app-entry" data-url="{{guard_url('user/client/create')}}">
        ...
        <div class="app-list-toolbar">
            ...
            <div class="app-items" data-url="{{guard_url('user/client')}}" id="item-list">
                @include('user::default.more', ['mode' => 'list'])
            </div>
        </div>
    </div>
...
<script type="">
    var module_link = "{{guard_url('user/client')}}";
