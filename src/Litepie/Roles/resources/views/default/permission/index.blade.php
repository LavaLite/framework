    ...
    <div class="app-list-inner">
        <div class="app-list-header d-flex align-items-center justify-content-between">
            ...
            <button type="button" class="btn add-app-btn btn-icon btn-outline" data-action='CREATE'
                data-load-to="#app-entry" data-url="{{guard_url('roles/permission/create')}}">
        ...
        <div class="app-list-wrap-inner ps ps--active-y" id="app-list">
            <div class="app-list-toolbar">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="{{guard_url('roles/role')}}"><i class="las la-lock-open"></i>Roles</a>
                        <a class="dropdown-item" href="{{guard_url('roles/permission')}}"><i class="las la-check-circle"></i>Permissions</a>
            ...
            <div class="app-items" data-url="{{guard_url('roles/permission')}}" id="item-list">
                @include('roles::permission.more', ['mode' => 'list'])
            </div>
...
<script type="">
    var module_link = "{{guard_url('roles/permission')}}";
