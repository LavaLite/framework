        ...
        <div class="row">
            <div class="col-12">
                <div class="app-entry-form-section" id="basic">
                    <div class="section-title">{{trans('setting::setting.title.email')}} {!! trans('setting::setting.name') !!}</div>
                    <div class='row'>
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                -> label(trans('setting::setting.label.mail.from_address'))
                                                -> options(__('settings::setting.options.mail.from_address'),
                                                env('MAIL_FROM_ADDRESS'))!!}
                                            </div>
                                            <div class="col-md-12">
                                                {!! Form::select('env[MAIL_FROM_NAME]')
                                                -> label(trans('setting::setting.label.mail.from_name'))
