<div class="app-entry-form-wrap">
    ...
    ->method('POST')
    ->files('true')
    ->action(guard_url('setting/setting/social'))!!}
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="app-entry-form-section" id="basic">
                    <div class="section-title">{{trans('setting::setting.title.social')}} {!! trans('setting::setting.name') !!}</div>
                    <div class='row'>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                ->
                                                placeholder(trans('setting::setting.placeholder.social.twitter_client_secret'))!!}
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                ->
                                                placeholder(trans('setting::setting.placeholder.social.facebook_client_secret'))!!}
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                ->
                                                placeholder(trans('setting::setting.placeholder.social.google_client_secret'))!!}
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                ->
                                                placeholder(trans('setting::setting.placeholder.social.linkedin_client_secret'))!!}
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                -> value(env('LINKEDIN_CLIENT_SECRET'))
                                                ->
                                                placeholder(trans('setting::setting.placeholder.social.github_client_secret'))!!}
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
